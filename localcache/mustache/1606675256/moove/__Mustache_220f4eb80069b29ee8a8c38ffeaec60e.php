...
class __Mustache_220f4eb80069b29ee8a8c38ffeaec60e extends Mustache_Template
{
...
';
        // 'isediting' section
        $value = $context->find('isediting');
        $buffer .= $this->section04bd09f6396b6953664fc312c2d6b1ee($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section5c9477d927d26521b2fa37b0aca8c915(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'deletetile, format_tiles';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= 'deletetile, format_tiles';
                $context->pop();
            }
        }
    ...
    private function section84e53a0fcaddfec61701c01cbcddf99d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                // 'str' section
                $value = $context->find('str');
                $buffer .= $this->section5c9477d927d26521b2fa37b0aca8c915($context, $indent, $value);
                $buffer .= '
';
                $buffer .= $indent . '                    </a>
';
...
';
    ...
    private function section04bd09f6396b6953664fc312c2d6b1ee(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section84e53a0fcaddfec61701c01cbcddf99d($context, $indent, $value);
