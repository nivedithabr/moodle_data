...
class __Mustache_e051dd2052fec05639430c759ef20b25 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section07aedaa29b0d9ac987f20247653c083a($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionA52c4952ff4edca9ad909e77f1082683(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section07aedaa29b0d9ac987f20247653c083a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionA52c4952ff4edca9ad909e77f1082683($context, $indent, $value);
                $context->pop();
            }
        }
